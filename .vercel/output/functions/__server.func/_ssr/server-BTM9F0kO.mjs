...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DVdEjL8Q.mjs");
...
const manifest = {
  "529679f31bb3665b04d0812e6a33f58f04ee783a74f3a28b5204b63d12ce5572": {
    functionName: "parseStatement_createServerFn_handler",
    importer: () => import("./statements.functions-4QvZyCXU.mjs")
  },
  "a5d6090938d741d43be3931ee520be6d67b4804d44735619f4f3685befd6519b": {
    functionName: "computeHealthScore_createServerFn_handler",
    importer: () => import("./health-score.functions-CBEpMlOP.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-4-xoO-pc.mjs").then((n) => n.r),
    import("./start-Bukhrjwq.mjs"),
